...
// Lưu ngưỡng theo từng bệnh nhân
    ...
    public String savePatientThreshold(
        ...
        // [FIX] Validate min < max ngay ở tầng server — tránh bác sĩ lỡ tay
        // nhập ngưỡng tối thiểu lớn hơn tối đa, khiến logic OR ở
        // checkPersonalThreshold() luôn báo "vượt ngưỡng" (vì mọi giá trị
        // đều đồng thời > max và < min).
